...
const restaurant = {
  ...
  // ES6 function expression removing :function
...
//Arrays
const users = [{ name: 'Coco', isMayor: true, favFood: 'Fish' }];

console.log(users[0]?.name ?? 'User array empty'); // Coco
...
let averageOdds = addOdds / oddsValues.length;
...
// rest.set(1, 'Rom, Italy');
// rest.set(2, 'Hamburg, Germany');
// rest
...
function listen() {
  const strings = inputText.value.split('\n');
